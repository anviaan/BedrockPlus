...
public class BedrockPlusMod implements ModInitializer {
	...
	public static final RegistryKey<ItemGroup> MANGO = RegistryKey.of(RegistryKeys.ITEM_GROUP, new Identifier(MOD_ID, "bedrockplus_item_group"));


	@Override
	public void onInitialize() {
		LOGGER.info("Hello from BedrockPlus Mod!");
