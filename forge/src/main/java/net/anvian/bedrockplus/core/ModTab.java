...
public class ModTab {
    ...
    public static RegistryObject<CreativeModeTab> BEDROCKPLUS = CREATIVE_MODE_TAB.register("impure_bedrock", () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.IMPURE_BEDROCK_INGOT.asItem())).title(Component.translatable("itemGroup.impure_bedrock")).build());
