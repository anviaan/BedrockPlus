...
public class ModItemRegistry {
    public static void registerItems() {
        ...
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, Constants.IMPURE_BEDROCK_UPGRADE_SMITHING_TEMPLATE_ID), ModItems.IMPURE_BEDROCK_UPGRADE_SMITHING_TEMPLATE);
        ...
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, Constants.IMPUREBEDROCK_HELMET_ID), ModItems.IMPURE_BEDROCK_HELMET);
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, Constants.IMPUREBEDROCK_CHESTPLATE_ID), ModItems.IMPURE_BEDROCK_CHESTPLATE);
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, Constants.IMPUREBEDROCK_LEGGINGS_ID), ModItems.IMPURE_BEDROCK_LEGGINGS);
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, Constants.IMPUREBEDROCK_BOOTS_ID), ModItems.IMPURE_BEDROCK_BOOTS);
    }
}
