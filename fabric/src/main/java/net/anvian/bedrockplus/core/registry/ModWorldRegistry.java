...
public class ModWorldRegistry {
    private static final ResourceKey<PlacedFeature> IMPUREBEDROCK_PLACED = ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(Constants.MOD_ID, "impurebedrock_placed"));
